          ...
          <ul className="menu__ul">
            <li className="menu__li">
              <a href="close" className="menu__a">
                <img
                  src="src/assets/img/menu__icon-1.svg"
                  width="24px"
                  height="24px"
                />
                Закрыть
            ...
            <li className="menu__li">
              <a href="/GOLDEN/account.php" className="menu__a">
                <img
                  src="src/assets/img/menu__icon-2.svg"
                  width="24px"
                  height="24px"
                />
                Личный кабинет
            ...
            <li className="menu__li">
              <a href="/GOLDEN/product.php" className="menu__a">
                <img
                  src="src/assets/img/menu__icon-3.svg"
                  width="24px"
                  height="24px"
                />
                Продукты / Лицензии
            ...
            <li className="menu__li">
              <a href="/GOLDEN/finance.php" className="menu__a">
                <img
                  src="src/assets/img/menu__icon-4.svg"
                  width="24px"
                  height="24px"
                />
                Мои финансы
            ...
            <li className="menu__li">
              <a href="/GOLDEN/partners.php" className="menu__a">
                <img
                  src="src/assets/img/menu__icon-5.svg"
                  width="24px"
                  height="24px"
                />
                Партнёру
            ...
            <li className="menu__li">
              <a href="/GOLDEN/p2p.php" className="menu__a">
                <img
                  src="src/assets/img/menu__icon-7.svg"
                  width="24px"
                  height="24px"
                />
                P2P Платформа
            ...
            <li className="menu__li">
              <a href="/GOLDEN/events.php" className="menu__a">
                <img
                  src="src/assets/img/menu__icon-8.svg"
                  width="24px"
                  height="24px"
                />
                Мероприятия
            ...
            <li className="menu__li">
              <a href="/GOLDEN/news.php" className="menu__a">
                <img
                  src="src/assets/img/menu__icon-9.svg"
                  width="24px"
                  height="24px"
                />
                Новости
            ...
            <li className="menu__li">
              <a href="/GOLDEN/profile.php" className="menu__a">
                <img
                  src="src/assets/img/menu__icon-10.svg"
                  width="24px"
                  height="24px"
                />
                Профиль
            ...
            <li className="menu__li">
              <a href="/GOLDEN/support.php" className="menu__a">
                <img
                  src="src/assets/img/menu__icon-11.svg"
                  width="24px"
                  height="24px"
                />
                Поддержка
